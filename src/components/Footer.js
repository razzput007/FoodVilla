...
const Footer = () => {
  ...
  return (
    ...
    <div className="footer text-center text-sm font-medium font-poppins h-10 flex justify-center items-center ">
      <h1 data-testid="footer">© 2023 made by Raja Kumar</h1>
    </div>
   </>
  )
};
